...
2. Create column names for the training and test files
...
--------------
--------------
Below is the README file for the original database and provides detailed information regarding the original data.
--------------
--------------
